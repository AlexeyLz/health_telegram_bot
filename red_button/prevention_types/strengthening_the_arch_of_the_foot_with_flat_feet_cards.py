...
TABLE_NAME = 'strengthening_the_arch_of_the_foot_with_flat_feet'
USUAL_STATE = 'strengthening_the_arch_of_the_foot_with_ff_cards'
END_STATE = 'strengthening_the_arch_of_the_foot_with_ff_cards_end'
...
async def start_stac_cards(call):
    number_exercise = 1
