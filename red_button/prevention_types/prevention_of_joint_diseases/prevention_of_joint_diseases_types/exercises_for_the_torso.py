...
import \
    red_button.prevention_types.prevention_of_joint_diseases.prevention_of_joint_diseases_types.exercises_for_the_torso_cards as eftc

STATE = 'prevention_of_joint_diseases_part_3'
...
async def callbacks_num(call: types.CallbackQuery):
    ...
    if action == "1":
        ...
        await eftc.start_eftc_cards(call)
    elif action == "2":
