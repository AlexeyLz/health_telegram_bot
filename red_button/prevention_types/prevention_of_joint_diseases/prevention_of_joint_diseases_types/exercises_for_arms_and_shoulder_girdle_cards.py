...
TABLE_NAME = 'prevention_of_joint_diseases_part_1'
USUAL_STATE = 'prevention_of_joint_diseases_part_1_cards'
END_STATE = 'prevention_of_joint_diseases_part_1_cards_end'
...
async def start_efc_cards(call):
    number_exercise = 1
