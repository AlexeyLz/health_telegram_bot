...
TABLE_NAME = 'prevention_of_joint_diseases_part_3'
USUAL_STATE = 'prevention_of_joint_diseases_part_3_cards'
END_STATE = 'prevention_of_joint_diseases_part_3_cards_end'
...
async def start_eftc_cards(call):
    number_exercise = 1
