...
TABLE_NAME = 'with_increased_neuro_emotional_stress'
USUAL_STATE = 'with_increased_neuro_emotional_stress_cards'
END_STATE = 'with_increased_neuro_emotional_stress_cards_end'
...
async def start_winc_cards(call):
    number_exercise = 1
