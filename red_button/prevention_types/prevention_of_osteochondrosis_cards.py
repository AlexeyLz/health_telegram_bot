...
TABLE_NAME = 'prevention_of_osteochondrosis'
USUAL_STATE = 'prevention_of_osteochondrosis_cards'
END_STATE = 'prevention_of_osteochondrosis_cards_end'
...
async def start_poc_cards(call):
    number_exercise = 1
