...
TABLE_NAME = 'flat_feet_and_varicose_veins'
USUAL_STATE = 'flat_feet_and_varicose_veins_cards'
END_STATE = 'flat_feet_and_varicose_veins_cards_end'
...
async def start_ffvc_cards(call):
    number_exercise = 1
