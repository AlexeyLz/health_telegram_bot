...
import red_button.minute_types.removing_fatigue_from_the_shoulder_girdle_and_arms_cards as rem_fatig
...
async def start_rem_fatig(call):
...
async def callbacks_num(call: types.CallbackQuery):
    ...
    if action == "1":
        ...
        await rem_fatig.start_rem_fatig_cards(call)
    elif action == "2":
