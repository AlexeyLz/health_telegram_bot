...
def get_keyboard():
    buttons = [types.InlineKeyboardButton(text="Начать", callback_data="mixed_work_state_1.1"),
               types.InlineKeyboardButton(text="Назад", callback_data="mixed_work_state_1.2"),
...
@dp.callback_query_handler(Text(startswith="mixed_work_state_1"))
