...
import red_button.productivity_types.pause_types.hard_physical_labor as hpl
from bot_settings import dp
from card import Card

TABLE_NAME = 'hard_physical_labor'
USUAL_STATE = 'hard_physical_labor_cards'
END_STATE = 'hard_physical_labor_cards_end'
