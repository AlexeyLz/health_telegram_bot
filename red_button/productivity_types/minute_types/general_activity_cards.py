...
import red_button.productivity_types.minute_types.general_impact as gi
from bot_settings import dp
from card import Card

TABLE_NAME = 'general_impact'
USUAL_STATE = 'general_impact_cards'
END_STATE = 'general_impact_cards_end'
...
async def start_gic_cards(call):
    number_exercise = 1
