...
import red_button.productivity_types.minute_types.rest_leg_muscles as rlm
from bot_settings import dp
from card import Card

TABLE_NAME = 'rest_leg_muscles'
USUAL_STATE = 'rest_leg_muscles_cards'
END_STATE = 'rest_leg_muscles_cards_end'
...
async def start_rlmc_cards(call):
    number_exercise = 1
