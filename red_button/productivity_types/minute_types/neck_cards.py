...
import red_button.productivity_types.minute_types.rest_of_the_neck_muscles as ron
from bot_settings import dp
from card import Card

TABLE_NAME = 'rest_of_the_neck_muscles'
USUAL_STATE = 'rest_of_the_neck_muscles_cards'
END_STATE = 'rest_of_the_neck_muscles_cards_end'
...
async def start_ronc_cards(call):
    number_exercise = 1
