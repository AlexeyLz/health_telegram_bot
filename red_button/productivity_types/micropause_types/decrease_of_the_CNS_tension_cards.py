...
TABLE_NAME = 'micropause_decrease_of_the_CNS_tension'
USUAL_STATE = 'micropause_decrease_of_the_CNS_tension_cards'
END_STATE = 'micropause_decrease_of_the_CNS_tension_cards_end'
