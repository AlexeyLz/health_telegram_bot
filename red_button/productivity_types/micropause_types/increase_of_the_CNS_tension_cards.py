...
import red_button.productivity_types.micropause_types.increasing_excitability_of_the_nervous_system as ie
from bot_settings import dp
from card import Card
import main

TABLE_NAME = 'increasing_excitability_of_the_nervous_system'
USUAL_STATE = 'increasing_excitability_of_the_ns_cards'
END_STATE = 'increasing_excitability_of_the_ns_cards_end'
...
def get_end_keyboard():
    buttons = [types.InlineKeyboardButton(text="Разумеется", callback_data=END_STATE + "_state_1.1"),
